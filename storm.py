...
def main():
	...
	global brute
	global url
	print("> მეთოდები: (L7= CC/GET/TLS/CFB/CFBUAM/DGB/POST/HEAD/SLOW/CHECK)")
	mode = InputOption("> აირჩიეთ რომელიმე მეთოდი (ავტომატურად მითითებულია=TLS) :",["cc","get","tls","cfb","cfbuam","dgb","post","head","slow","check"],"TLS")
