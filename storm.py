...
def main():
	...
	global brute
	global url
	print("> მეთოდები: (L7= GET/HTTPFLOOD/HTTP-SOCKET/TLS/CFB/CFBUAM/CFKILL/JSBYPASS/DGB/POST/HEAD/SLOW/CHECK)")
	mode = InputOption("> აირჩიეთ რომელიმე მეთოდი (ავტომატურად მითითებულია=TLS) :",["get","tls","jsbypass","httpflood","httpsocket","cfb","cfbuam","cfkill","dgb","post","head","slow","check"],"TLS")
