...
def main():
	...
	global brute
	global url
	print("> მეთოდები: (L7= GET/HTTPFLOOD/TLS/CFB/CFBUAM/CFKILL/JSBYPASS/DGB/POST/HEAD/SLOW/CHECK)")
	mode = InputOption("> აირჩიეთ რომელიმე მეთოდი (ავტომატურად მითითებულია=TLS) :",["get","tls","jsbypass","httpflood","cfb","cfbuam","cfkill","dgb","post","head","slow","check"],"TLS")
