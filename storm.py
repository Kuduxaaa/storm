...
def main():
	...
	global brute
	global url
	print("> მეთოდები: (L7= GET/STORM/HTTPSFLOODS/HTTPSOCKET/Browser/TLS/RAND/CFB/CFBUAM/CFKILLS/JSBYPASS/DGB/OVH/POST/HEAD/SLOW/CHECK)")
	mode = InputOption("> აირჩიეთ რომელიმე მეთოდი (ავტომატურად მითითებულია=TLS) :",["get","tls","storm","rand","jsbypass","httpsfloods","httpsocket","browser","cfb","cfbuam","cfkills","dgb","ovh","post","head","slow","check"],"TLS")
